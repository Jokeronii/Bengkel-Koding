# -*- coding: utf-8 -*-
"""BK_hungarian_Marcell Adi Setiawan_A11.2020.12809.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Fl7mp6zDLazY8k9vSncrUcLQaq_eZIAw
...
"""#5.Membesihkan data/cleansing data"""
...
"""beberapa fitur memiliki value yang null(ada yang 90% null),perlu di cleansing"""
...
"""beberapa fitur(dengan hampir 90% null) sudah di drop,next mengisi value null pada beberapa fitur yang nilai nullnya sedikit"""
...
# dilakukan drop null terlebih dahulu untuk dapat dilakukan pengubahan datatype ke float(decimal) -> operasi mean lebih mudah dilakukan dengan desimal
...
#konverting fitur ke dalam bentuk float datatype
...
#mengambil nilai mean tiap fitur,menyimpan pada variable masing masing
...
"""next masuk ke filling null values tiap fitur"""
...
# re assign data yang sudah clean ke variable baru dfClean
dfClean = df_selected.fillna(value=fill_values)
print(dfClean.info())
print(dfClean.isnull().sum())

# melakukan cek duplikasi value
...
# save dengan bantuan library pickle
